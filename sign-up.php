...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index.html"><img src="images\15.png" alt="alternative"></a> 
                   ...
                   <p>Fill out the form below to sign up for Tivo. Already signed up? Then just <a class="white" href="log-in.html">Log In</a></p> 
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control-input" id="sname" required>
                                <label class="label-control" for="phone">Contact Number</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control-input" id="spassword" required>
                                <label class="label-control" for="cpassword">Confirm_Password</label>
                                <div class="help-block with-errors"></div>
                            </div>
...
if(isset($_POST["Submit"])) {
  ...
  if ($_POST["password"] === $_POST["cpassword"]) {
      ...
      $sql= "INSERT INTO  signup(Full_Name, Email, Phone_no, Password) VALUES('$name', '$email', $phone', $password', $cpassword)";
      //echo $query;die;
